...
# based on: https://gist.github.com/ferrine/89d739e80712f5549e44b2c2435979ef
...
if __name__ == "__main__":
    ...
    net = build_network([{'Conv2d': {"args": [3, 16, 25], "stride": 1, "padding": 2}},
                         {'BiMap': {"args": [10, 5]}},
                         {'Conv2d': {"args": [16, 25, 5], "stride": 1, "padding": 2}},
                         ], builder)
    print(net[1])
